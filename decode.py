...
input_file = r'/data/songlf/0.DNA_Storage/Shadow-Encryption/10.扩增子测序/data/song-ligation_12.fq.gz'

# file_type = 'dump_kmers'
output_file = 'seq-output-10.jpg'

kmer_size = 31
kmer_cut_off = 5
output_file = str(kmer_cut_off) + '-seq-output-10.jpg'
chunk_size = 30
chunk_num = 10517
fountain_seed = 2
index_bytes = 4
